...
[ICREATE TABLE IF NOT EXISTS corrections (
    user_id int not null,
    project_id int not null,
    score int default 0,
    KEY `user_id` (`user_id`),
...
This project was done by [SE. owoyomi taiwo adeyemi](https://github.com/owoyomi20). Feel free to get intouch with me;


:email: Email [owoyomitaiwoadeyemi@gmail.com](owoyomitaiwoadeyemi@gmail.com)
